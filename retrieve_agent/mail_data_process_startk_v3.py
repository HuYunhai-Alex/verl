...
if __name__ == "__main__":
    ...
    parser.add_argument("--local_dir", default="~/data/mail_ai_v5")
    parser.add_argument("--hdfs_dir", default=None)

    args = parser.parse_args()

    data_source = "/workspace/yunhai/rl-date-gen/pipeline_results_v5.jsonl"
    ...
    def make_train_map_fn(split):
        def process_fn(example, idx):
            ...
            if random.random() < 0.05:
                print(f"Processing question: {question_raw}")
            ...
            data = {
                ...
                "ability": "math",
                "reward_model": {"style": "rule", "ground_truth": ground_truth, "rel_requirements": example.get("rel_requirements", []), "text_requirements": example.get("text_requirements", [])},
                "extra_info": {
                    "split": split,
                    "index": idx,
    ...
    test_dataset = test_dataset.map(function=make_test_map_fn("test"), with_indices=True)
