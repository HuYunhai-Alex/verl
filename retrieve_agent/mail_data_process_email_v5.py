...
if __name__ == "__main__":
    ...
    parser.add_argument("--local_dir", default="/workspace/yunhai/data/mail_v5")
    parser.add_argument("--hdfs_dir", default=None)
    args = parser.parse_args()

    data_source = "/workspace/yunhai/data/sql_and_query_v5_email_2_with_sql2.json"
    ...
    def add_ground_truth(example, idx):
        ...
        if isinstance(gt, list):
            gt = [json.dumps(item, ensure_ascii=False) for item in gt]
    ...
    dataset = dataset.select(range(2999))
